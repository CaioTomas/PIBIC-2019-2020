...
\index{Teorema!Fundamental dos Grupos Cíclicos}
...
\label{sec-classes-laterais}
    ...
    %
	\begin{definition}[Classe lateral]
	\label{def classes laterais}
	\index{Classe lateral}
	...
	\end{definition}
	%
	\begin{theorem}[Teorema Órbita-Estabilizador]
	\label{orb-stab}
	\index{Teorema!Órbita-Estabilizador}
...
\label{sec-prod-direto-grupos}
    ...
    %
	\begin{definition}[Produto direto]
	\label{def prod direto externo}
	\index{Produto direto}
	...
	\end{remark}
	%
	\begin{theorem}[Classificação dos grupos de ordem 4]
	\label{teo-class-grupos-ord-4}
	\index{Teorema!de Classificação dos Grupos de Ordem 4}
...
\label{sec-subgrupos-normais}
	...
	%
	\begin{theorem}[Grupo quociente]
	\label{quociente}
	\index{Grupo quociente}
	...
	\end{proof}
	%
	\begin{theorem}[Classificação dos grupos de ordem $p^2$]
	\label{classificacao grupos de ordem p2}
	\index{Teorema!de Classificação dos Grupos de Ordem $p^2$}
...
\label{sec-homomorfismos}
	...
	\end{example}
	%
	\begin{theorem}[Primeiro Teorema dos Isomorfismos]
	\label{primeiro teorema de isomorfismo}
	\index{Primeiro Teorema dos Isomorfismos}
	...
	\end{equation*}
	%
	\begin{definition}[Produto semidireto]
	\label{produto semidireto}
	\index{Produto semidireto}
	...
	$G$ é dito \textbf{metacíclico}\index{Grupo metacíclico}. Em outras palavras, um grupo $G$ é \textbf{metacíclico} 
