...
\label{sec-homomorfismos}
	...
	\begin{proof}
		...
		\begin{align*}
		\phi(a) = \phi(b) \iff (\phi(b))^{-1}\phi(a) = \overline{e} \iff b^{-1}a\in \Ker\phi \overset{\text{Lema }\eqref{propriedades}}{\iff} a\Ker\phi = b\Ker\phi
		\end{align*}
		
		\par\vspace{0.3cm}\hspace{17pt}\textbf{6.} Seja $x\in\phi^{-1}(g')$. Então, sabemos que
		\begin{align*}
		\phi(x) = \phi(g) \overset{5}{\iff} x\Ker\phi = g\Ker\phi \overset{\text{Lema }\eqref{propriedades}}{\iff} x\in g\Ker\phi \therefore \phi^{-1}(g') \subseteq g\Ker\phi
		\end{align*}
	...
	\par\vspace{0.3cm} Seja $G = GL(n,\F)$. Seja $B$ o subgrupo de matrizes triangulares superiores em $G$, $T$ o subgrupo de matrizes diagonais em $G$ e $U$ o subgrupo de matrizes triangulares superiores com coeficientes diagonais unitários. Então, para $n=2$,
	\begin{equation*}
