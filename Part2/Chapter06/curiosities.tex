...
\label{secao o problema da palavra}
	Vamos agora falar mais um pouco sobre o problema da palavra em $B_n$. Mas o que é o problema da palavra?\index{Problema da Palavra}
	...
	\end{itemize}
	%
	entre outras classes. O problema da conjugação\index{Problema da Conjugação}
